...
mixin _$DtcCodeAbbreviationListController
  ...
  List<DtcCodeAbbreviation> get listFiltered =>
      (_$listFilteredComputed ??= Computed<List<DtcCodeAbbreviation>>(
        () => super.listFiltered,
        name: 'DtcCodeAbbreviationListControllerBase.listFiltered',
      )).value;

  late final _$codeCtrlAtom = Atom(
    name: 'DtcCodeAbbreviationListControllerBase.codeCtrl',
    context: context,
  );
  ...
  set _dtcCodeAbbreviationRepo(DtcCodeAbbreviationRepo value) {
    _$_dtcCodeAbbreviationRepoAtom.reportWrite(
      value,
      super._dtcCodeAbbreviationRepo,
      () {
  ...
  late final _$futureAtom = Atom(
    name: 'DtcCodeAbbreviationListControllerBase.future',
    context: context,
  );
  ...
  late final _$filterAtom = Atom(
    name: 'DtcCodeAbbreviationListControllerBase.filter',
    context: context,
  );
  ...
  late final _$DtcCodeAbbreviationListControllerBaseActionController =
      ActionController(
        name: 'DtcCodeAbbreviationListControllerBase',
        context: context,
      );
  ...
  bool setButtonVisibilty() {
    ...
    try {
      ...
      _$DtcCodeAbbreviationListControllerBaseActionController.endAction(
        _$actionInfo,
      );
    }
  }

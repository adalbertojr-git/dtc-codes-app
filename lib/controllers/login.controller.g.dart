...
mixin _$LoginController on LoginControllerBase, Store {
  late final _$userCtrlAtom = Atom(
    name: 'LoginControllerBase.userCtrl',
    context: context,
  );
  ...
  late final _$pswCtrlAtom = Atom(
    name: 'LoginControllerBase.pswCtrl',
    context: context,
  );
  ...
  late final _$tokenAtom = Atom(
    name: 'LoginControllerBase.token',
    context: context,
  );
  ...
  late final _$_loginRepoAtom = Atom(
    name: 'LoginControllerBase._loginRepo',
    context: context,
  );
  ...
  late final _$isPasswordVisibleAtom = Atom(
    name: 'LoginControllerBase.isPasswordVisible',
    context: context,
  );
